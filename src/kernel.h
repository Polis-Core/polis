...
bool CheckStakeKernelHash(unsigned int nBits, const CBlock &blockFrom, std::shared_ptr<const CTransaction> &txPrev, const COutPoint &prevout, unsigned int& nTimeTx, unsigned int nHashDrift, bool fCheck, uint256& hashProofOfStake, bool fPrintProofOfStake = false, bool fTPoS = false);
